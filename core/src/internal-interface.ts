/**
 * TODO FW-3135
 * We should be importing interfaces from the files directly
 * when using them internally otherwise we will get circular dependency
 * issues in Stencil 3 (See STENCIL-675). This is a temporary workaround
 * to avoid the circular dependency issue until the interface imports
 * can be migrated.
 */
