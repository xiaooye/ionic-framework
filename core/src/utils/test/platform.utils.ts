...
export const PlatformConfiguration = {
  AndroidTablet: {
    ...
    innerWidth: 800,
    innerHeight: 1200,
    matchMedia: mockMatchMedia(['(pointer:coarse)']),
  },
  Capacitor: {
    Capacitor: {
      isNative: true,
  ...
  GalaxyView: {
    navigator: {
      userAgent:
        'Mozilla/5.0 (Linux; Android 5.1.1; SM-T670 Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.87 Safari/537.36',
    },
    innerWidth: 1920,
    innerHeight: 1080,
    matchMedia: mockMatchMedia(['(pointer:coarse)']),
